...
public class CollaborationDirectAsyncProxy implements InvocationHandler{
	...
	/**
 */
	public CollaborationDirectAsyncProxy( AgentIdentity linkedAgent, Agent controller, AsyncHandler contextHandler) {
		super();
	...
	*/
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        AsyncHandler handler = contextHandler;
		AsyncHandlerProcess asyncProcess = new AsyncHandlerProcess(handler,method, args);
    ...
    public class AsyncHandlerProcess implements Runnable{
        ...
        public void run() {
            ...
            try {
            	...
            	Class[] actualParameters = new Class[classes.length];
